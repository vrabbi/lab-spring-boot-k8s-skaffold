Spring Boot comes with features that make it work well in Kubernetes. This lab shows you how to work with [Skaffold]() to reduce the toil of developing and pushing applications to Kubernetes. To do this we need to do two things:
